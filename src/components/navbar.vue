<template>
    <div>
            ...
            <div class="max-w-screen-xl mx-auto flex justify-between items-center">
                ...
                <div class="md:hidden">
                    ...
                    <button
                        @click="toggleMenu"
                        v-if="menuOpen"
                        class="text-white z-50 cursor-pointer relative"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div v-if="menuOpen" class="absolute top-0 left-0 right-0 bottom-0 bg-gray-500 z-40 text-white p-4 flex flex-col justify-center items-center">
            <router-link to="/home" class="block py-2 px-4 cursor-pointer">Home</router-link>
            <router-link to="/about" class="block py-2 px-4 cursor-pointer">Sobre mim</router-link>
            <router-link to="/trilha" class="block py-2 px-4 cursor-pointer">Experiencia</router-link>
            <router-link to="/portfolio" class="block py-2 px-4 cursor-pointer">Portfolio</router-link>
            <router-link to="/contact">
